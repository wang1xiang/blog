...
description: "不需要记很多命令，只需要输入/就可以添加你想要的标签"
tags: ["vscode"]
category: "编辑器"
image: api
draft: false
...
![vscode-markdown.png](./vscode-markdown.png)
...
![chrome-snippetes.png](./chrome-snippetes.png)
...
![used-snippets.png](./used-snippets.png)

而且虽然你不知道，但你还天天用着它，比如在快速创建 vue 的单文件组件代码：
![vue3-snippets.gif](./vue3-snippets.gif)
...
1. 创建 snippet
   ...
   ![vscode-new-snippets.png](./vscode-new-snippets.png)
...
3. snippet 语法
   ...
   - 通过`${1:xxx}`定义 placeholder
     ...
     ![snippet-default](./snippet-default.gif)
...
4. 案例
   ...
   ![react-usestate-snippet.gif](./react-usestate-snippet.gif)
...
![snippets-generate.png](./snippets-generate.png)
...
- Markmap
  ...
  ![markdown-map.png](./markdown-map.png)
...
![vscode-markdown.gif](./vscode-markdown.gif)

6 月 17 号更新 bash、html、js、css、vue 代码片段，使用如下：

![vue-html-snippets.gif](./vue-html-snippets.gif)
