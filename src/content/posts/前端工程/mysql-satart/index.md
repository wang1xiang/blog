...
![mysql-docker-run](./mysql-docker-run.png)
...
![mysql-navicate-start](./mysql-navicate-start.png)

点击此按钮创建一个 schema，也就是一个数据库

![mysql-create-schema](./mysql-create-schema.png)
...
![mysql-create-table](./mysql-create-table.png)
...
![mysql-all-data](./mysql-all-data.png)
