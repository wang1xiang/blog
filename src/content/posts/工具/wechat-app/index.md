...
[小程序组件](https://upload-images.jianshu.io/upload_./1480597-62a5f00053f5f0d1.png)
...
2. `https://xxx.com` 不在以下 request 合法域名列表中，请参考文档：[网络配置](https://developers.weixin.qq.com/miniprogram/dev/framework/ability/network.html)
   ...
   - 开发环境需要配置
     ![develop-origin-error](./develop-origin-error.png)
   - 生产环境配置
     ![production-origin-error](./production-origin-error.png)
