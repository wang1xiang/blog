...
![electron-process1](./electron-process1.png)
![electron-process2](./electron-process2.png)
![electron-process3](./electron-process3.png)
...
![electron-code-source](./electron-code-source.png)

主进程创建窗口 -> 窗口加载渲染进程文件

![main-process-create-window](./main-process-create-window.png)
...
![vite-render-config](./vite-render-config.png)
...
![electron-demos](./electron-demos.png)
...
1. 使用苹果开发者账号登录 https://developer.apple.com/account/resources/identifiers/list ，创建新 identifier
   ...
   ![mac-sign](./mac-sign.png)

   ![mac-sign1](./mac-sign1.png)

   ![mac-sign2](./mac-sign2.png)
...
2. https://appstoreconnect.apple.com/apps 创建新 app
   ...
   ![mac-sign3](./mac-sign3.png)

3. https://appleid.apple.com/account/manage 创建 App 专用密码，此密码公证时使用

   ![mac-sign4](./mac-sign4.png)

4. 创建自签名证书

   ![mac-sign5](./mac-sign5.png)
   ![mac-sign6](./mac-sign6.png)
   ![mac-sign7](./mac-sign7.png)
   ![mac-sign8](./mac-sign8.png)

   证书可以导出为.p12 文件（会要求为 p12 设置密码），新设备签名时可以把此文件导入钥匙链

5. 如果已有证书文件，跳过第 4 步。双击 p12 文件把证书导入钥匙链，输入证书密码

   ![mac-sign9](./mac-sign9.png)
