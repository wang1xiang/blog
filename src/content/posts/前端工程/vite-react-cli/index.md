...
description: "集成React-Router、Antd、Redux-Toolkit和React-Query，并封装ESLint+Prettier+Husky的React项目脚手架，快来试试吧！"
tags: ["vite"]
category: "前端工程"
image: api
draft: false
...
# ![create-vct](./create-vct.svg) create-vct

这是一个用于初始化 vite + React 企业级项目的脚手架工具。

## 🔥 运行流程

![create-vct-flow.gif](./create-vct-flow.gif)
...
![create-vite-load.png](./create-vite-load.png)
...
![create-vite-delete.png](./create-vite-delete.png)
...
![eslint-logo.png](./eslint-logo.png)
...
9. 到这里，husky + lint-staged + commitlint 都配置完成了。
   ...
   ![husky-error.png](./husky-error.png)
...
![redux-toolkit-logo.png](./redux-toolkit-logo.png)
...
![react-query-logo](./react-query-logo.png)
...
2. 创建 api 文件夹
   ...
   ![axios-ts-resdata](./axios-ts-resdata.gif)
...
![package-bin.png](./package-bin.png)
