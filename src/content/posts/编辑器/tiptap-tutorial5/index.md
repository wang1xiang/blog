...
description: "思考一下，如果想要实现一个富文本编辑器的的协同编辑，你能想到哪几种方案呢 🐶？ 呼之欲出的方案 直接覆盖 这个是最最简单粗暴的办法......"
tags: ["tiptap"]
category: "编辑器"
image: api
draft: false
...
![yjs-architecture](./yjs-architecture.png)
