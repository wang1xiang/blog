...
![gitlab-github-username.png](./gitlab-github-username.png)

## github 的头像不显示了？

![github-error-username](./github-error-usename.png)
...
![github-global-username](./github-global-usename.png)
...
![git-filter-logs](./git-filter-logs.png)
...
2. 执行此脚本，过程略微有点慢
   ...
   .![git-filter-branch.png](./git-filter-branch.png)
   ...
   ![git-filter-branch-error](./git-filter-branch-error.png)

3. 执行完成后，通过[git logs](https://juejin.cn/post/7228869305549537336#heading-11)再次查看：

   ![git-filter-logs1.png](./git-filter-logs1.png)

最后，在`git push -f`就大功告成了 🎉！，再看下 github 的 commit 历史，不错，头像都出来了。
![github-right-usename](./github-right-usename.png)
