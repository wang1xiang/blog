...
![flutter-init-lifecycle](./flutter-init-lifecycle.png)

接着通过点击 ⚡️ 按扭触发热重载：

![flutter-hot-reload-lifecycle](./flutter-hot-reload-lifecycle.png)

接下来我们在 widget 树中删除 CounterWidget

![flutter-remove-widget-lifecycle](./flutter-remove-widget-lifecycle.png)
...
![flutter-state-lifecycle](./flutter-state-lifecycle.png)
...
![flutter-context-state](./flutter-context-state.png)
