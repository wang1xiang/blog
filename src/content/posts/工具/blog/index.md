...
3. 项目
   ...
   ![final-cut-pro-new](./final-cut-pro-new.png)

   使用自定义设置，完成后
   自动设置也可

   ![final-cut-pro-three](./final-cut-pro-three.png)
...
![final-cut-pro-window](./final-cut-pro-window.png)
...
![final-cut-pro-mind](./final-cut-pro-mind.png)
...
![fcpx-shortcut-keys](./fcpx-shortcut-keys.png)
