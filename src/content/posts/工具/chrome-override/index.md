...
![ajax-modifier](./ajax-modifiler-png.png)
...
![overrides-xml](./overrides-xml.png)
...
1. 右键选择需要修改的请求
   ...
   ![override-content-step1](./override-content-step1.png)
...
2. 选择文件夹
   ...
   ![override-content-step2](./override-content-step2.png)

   ![override-content-step3](./override-content-step3.png)
...
3. 修改请求结果
   ...
   ![override-content-step3-source](./override-content-step3-source.png)

   比如我们可以修改上面的数量，看看超出屏幕范围后的弹窗位置是否正常显示：

   ![override-content-step3-override](./override-content-step3-override.png)
...
![override-content-delete](./override-content-delete.png)
