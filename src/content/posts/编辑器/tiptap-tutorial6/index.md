...
1. 在当前项目下启动 y-websocket 服务
   ...
   ![local-websocket](./local-websocket.png)
...
![y-doc-property](./y-doc-property.png)
...
![yjs-event-order](./yjs-event-order.png)
...
![yjs-event-order-test](./yjs-event-order-test.png)
...
![y-map-observe](./y-map-observe.png)
...
![yjs-event-update](./yjs-event-update.png)
...
![yjs-ytext-socket](./yjs-ytext-socket.gif)
...
![yjs-awareness-demo](./yjs-awareness-demo.png)
...
![yjs-no-captureTimeout](./yjs-no-captureTimeout.png)

调用 stopCapturing 方法：
![yjs-captureTimeout](./yjs-captureTimeout.png)
