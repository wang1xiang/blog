...
输出结果如下所示：
![electron-life-cycle](./electron-life-cycle.png)
...
![electron-render-main](./electron-render-main.png)
...
![electron-render-2-main](./electron-render-2-main.png)
...
![electron-pmp.png](./electron-pmp.png)
...
- 代码签名
  ...
  如果用户安装未签名的软件，会提示如下：
  ![electron-no-sign](./electron-no-sign.png)
...
- 公证
  ...
  ![electron-no-notarization](./electron-no-notarization.png)
