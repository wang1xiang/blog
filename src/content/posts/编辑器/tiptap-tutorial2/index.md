...
description: "站在巨人的肩膀上，使用它Tiptap从0-1快速搭建富文本编辑器，会给你与其他富文本编辑器不一样的体验，快来试试吧！！！"
tags: ["tiptap"]
category: "编辑器"
image: api
draft: false
...
3. 创建组件
   ...
   ![tiptap-demo.png](./tiptap-demo.png)
...
![starterKit-simple-demo](./starterKit-simple-demo.png)
...
3. 使用
   ...
   ![bubble-menu-demo.png](./bubble-menu-demo.png)
...
![float-menu-demo.gif](./float-menu-demo.gif)
...
![slash-menu-demo.gif](./slash-menu-demo.gif)
...
- 向扩展添加自定义类
  ...
  ![custom-extension-class.png](./custom-extension-class.png)
...
- 向编辑器添加自定义类
  ...
  ![custom-editor-class.png](./custom-editor-class.png)
...
- 自定义标记将节点
  ...
  ![custom-mark-class.png](./custom-mark-class.png)
