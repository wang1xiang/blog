...
![pretty-js.png](./pretty-js-png.png)
...
![ajax-modifier-png.png](./ajax-modifiler-png.png)
...
![cookie-editor-png.png](./cookie-editor-png.png)

### Smart TOC

自动提取网页标题，生成目录。非常适合一些没有标题的网站，快速到达自己想要浏览的地方。

![smart-toc-png.png](./smart-toc-png.png)
...
![octotree-png.gif](./octotree-png.gif)
