...
![flutter-fvm-version](./flutter-fvm-version.png)

通过 which flutter 打印出的路径是否正确

![flutter-fvm-path](./flutter-fvm-path.png)
  ...
  return Column(
    children: [
      ...
      Padding(
        ...
        child: Image.asset('assets/./3.0x/launch_bottom_image.png', width: 252),
      ).center(),
    ],
  );
}
