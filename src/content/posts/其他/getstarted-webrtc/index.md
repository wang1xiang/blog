...
description: "本文是针对小白的 WebRTC 快速入门课，如果你还之前还不了解 WebRTC，不了解实时通讯，希望你能认真阅读本文，实现对 WebRTC 的零的突破 💪。"
...
![can-i-use-webrtc.png](./can-i-use-webrtc.png)
...
![webrtc-architecture.png](./webrtc-architecture.png)
...
![webrtc-flow.png](./webrtc-flow.png)
...
![enumerateDevices-demo.png](./enumerateDevices-demo.png)
...
- MediaDevices.getDisplayMedia()
  ...
  ![mediaDevices-getDisplayMedia.png](./mediaDevices-getDisplayMedia.png)
...
最后，看一下效果如下：
![socketIO-demo.png](./socketIO-demo.png)

顺便看一下日志信息：
![socketIO-demo-log.png](./socketIO-demo-log.png)
...
![ice-candidate-demo.png](./ice-candidate-demo.png)
...
![net-address.png](./net-address.png)
...
打印出的 Candidate 如下所示：
![on-icecandidate.png](./on-icecandidate.png)
