...
![selection-range](./selection-range.png)
...
![window-getSelection](./window-getSelection.png)

**Firefox**

![window-getSelection-firefox](./window-getSelection-firefox.png)
...
![window-getSelection-getRangeAt](./window-getSelection-getRangeAt.png)
...
![window-getSelection-selection](./window-getselection-selection.gif)
...
![window-getSelection-move](./window-getselection-move.gif)
...
![window-getSelection-extend](./window-getselection-extend.gif)
