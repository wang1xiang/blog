...
![flutter-framework-three](./flutter-framework-three.png)
...
![flutter-sdk-download](./flutter-sdk-download.png)
...
![flutter-git-init](./flutter-git-init.png)
...
![flutter-doctor1](./flutter-doctor1.png)
...
![flutter-cocoapods-install](./flutter-cocoapods-install.png)
...
![flutter-android-sdk-error](./flutter-android-sdk-error.png)

#### cmdline-tools component is missing

需要安装 Android SDK command-line Tools

![flutter-android-sdk](./flutter-android-sdk.png)
...
4. 开始创建，回车后 VSCode 自动创建 flutter 项目，需要稍等片刻
   ...
   ![flutter-vscode-create](./flutter-vscode-create.png)

5. 创建完成

   ![flutter-vscode-create1](./flutter-vscode-create1.png)

### 项目目录

![flutter-application-tree](./flutter-application-tree.png)
...
3. 启动完成，如下
   ...
   ![flutter-application-success](./flutter-application-success.png)
