...
description: "如果你用惯了process-on 和 drawio这类流程图工具，那么是时候试试白板了，发挥你的想象力，创造不一样的东西。"
tags: ["work"]
category: "工作"
image: api
draft: false
...
![exclidraw-pic.gif](./exclidraw-pic.gif)
...
![exclidraw-flow.gif](./exclidraw-flow.gif)
...
![exclidraw-chart.gif](./exclidraw-chart.gif)
...
![excalidraw-logo.png](./excalidraw-logo.png)
...
![excalidraw-plus.png](./excalidraw-plus.png)
...
![excalidraw-room.png](./excalidraw-room.png)

好处是可以直接修改源码，哪部分想替换成自己的东西就改哪。坏处是一旦改了源码，那么官方更新之后对比起来太麻烦了，而且目前看官方代码更新挺频繁的。
![excalidraw-gitlogs.png](./excalidraw-gitlogs.png)
...
![excalidraw-basic.png](./excalidraw-basic.png)
...
![excalidraw-css-var.png](./excalidraw-css-var.png)
...
- libraryReturnUrl
  ...
  ![excalidraw-name.png](./excalidraw-name.png)
